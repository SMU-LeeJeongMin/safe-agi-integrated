...
SCENARIOS = [
    ...
    ("E1", "복합 이상 감지 + 무응답", "복합 생체·물리 이상 감지 + 무응답 → 단계적 확인 후 자동 구조 요청", False),
